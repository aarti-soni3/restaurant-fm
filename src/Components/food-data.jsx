// not use export default foodData =[] because it means you using both named n default export default name we used n with that the object name we used so avoid both.
